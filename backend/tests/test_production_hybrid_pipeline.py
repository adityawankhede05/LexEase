...
def test_production_hybrid_pipeline_flow():
    ...
    # Predict local values if ML models are loaded
    if local_classifier and local_risk_engine:
        ...
        c_type, c_conf = "UNKNOWN/OTHER", 0.0
        l_risk = {
            "risk_score": 50.0,
            "risk_level": "medium",
    ...
    trace_info = {
        ...
        "groq_risk_score": result.get("risk_score"),
